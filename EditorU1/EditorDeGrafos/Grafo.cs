        ...
        public int[,] matrizDeAdyacencia()
        {
          ...
          //  Console.Write(contador+"\n");
            ...
            using (StreamWriter escribir = new StreamWriter("C:\\Users\\Ulises\\Desktop\\EditorDeGrafos\\EditorU - copia\\archivo2.txt"))
            {
                ...
                escribir.WriteLine("matrizadyasencia grafo secundario\n");
                ...
                matrizdos = new int[this.Count, this.Count];
                for (int i = 0; i < this.Count; i++)
                {
                    for (int j = 0; j < this.Count; j++)
                    {
                        matrizAdyacencia[i, j] = grafoM[i].Aristas[j].Peso;
                        matrizdos[i, j] = grafoM[i].Aristas[j].Peso;
                        escribir.Write(matrizdos[i, j]);
                ...
                //matrizAdyacencia = new int[this.Count, this.Count];
                /*     using (StreamWriter escribir = new StreamWriter("C:\\Users\\Ulises\\Desktop\\EditorDeGrafos\\EditorU - copia\\archivo.txt"))
                     {
                         ...
                         for (int i = 0; i < this.Count; i++)
                         {
                             for (int j = 0; j < this.Count; j++)
                             {
                                 escribir.Write(matrizdos[i, j].ToString());
                             }
                             escribir.WriteLine("");
