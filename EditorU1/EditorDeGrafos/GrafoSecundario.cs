...
namespace EditorDeGrafos
{
    partial class GrafoSecundario : Form
    {
        ...
        private void GrafoSecundario_Load(object sender, EventArgs e)
        {
            ...
            this.altoName = 10;
            this.tamName = 6;
            this.nombre = this.numNodos.ToString();
        ...
        public string ConvierteNombre(int n)
        {
            ...
            {
                cad = numNodos.ToString(); // ((char)(numNodos + 64)).ToString()
            }
            return cad;
        }
        #endregion
        ...
        private void mueveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.opcion = 5;
        }
        ...
        private void salirToolStripMenuItem_Click(object sender, EventArgs e) //borrar grafo
        {
            if (MessageBox.Show("¿Seguro quiere eliminar el grafo?", "No me quiero ir señor usuario :'(", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                grafo.borraGrafo();
        ...
        private void guardarToolStripMenuItem_Click(object sender, EventArgs e) // abrir
        {
            IFormatter formater = new BinaryFormatter();
            Stream stream;
            openFileGrafo = new OpenFileDialog();
        ...
        private void borrarGrafoToolStripMenuItem_Click(object sender, EventArgs e) //guardar
        {
            IFormatter formater = new BinaryFormatter();
            Stream stream;
            saveFileGrafo.Filter = "(*.grafo) | *.grafo";
